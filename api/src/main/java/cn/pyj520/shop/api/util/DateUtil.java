...
public class DateUtil {
     ...
     */
    public static final String DATE_FORMAT_YYYYMMDD_BAR = "yyyy/MM/dd";
    ...
    public static final String DATE_FORMAT_YYYYMMDDHHMI = "yyyy-MM-ddHH:mm";
    ...
    public static Date parseStrToDate(String time, String timeFromat) {
        ...
        Date date = null;
        try {
            date = parseStrToDate1(time, timeFromat);
        } catch (Exception e) {
     ...
     * 需要一个抛出异常的方法
     */
    public static Date parseStrToDate1(String time, String timeFromat) throws ParseException {
        DateFormat dateFormat = new SimpleDateFormat(timeFromat);
    ...
    public static boolean compareIsSameDay(Date day1, Date day2) {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
    ...
    /**
     * 为excel的比如这个字符串是“16-十月-1980” 进行处理的专门方法
     *
     * @param time String类型时间
     * @param
     * @return 格式化后的Date日期
     */
    public static Date parseStrToDateByChina(String time) throws ParseException {
        if (time == null || time.equals("")) {
            return null;
        }
        Date date = null;
        DateFormat dateFormat = new SimpleDateFormat("dd-MMM-yyyy", Locale.CHINA);
    ...
    /**
     * 获取今天时间范围
     * @return list中第一个参数为结束，第二个参数为开始时间
     */
